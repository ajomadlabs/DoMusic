...
if(!$con) {
    ...
    $sql="select * from profile where p_uname='$u'";
        ...
        <div class="row" id="aboutme" style="margin: -64px 1px;">
            <div class="col s2 white z-depth-1">
                ...
                <div class="card-image">
                    <?php if($pp=="nil"){ 
							echo "<img src='img/lu.jpg' style='margin:0px 18px 0px -127px;border:solid black 1px;display:block;' class='img-circle'                                           width='400px' height='200px' alt='Upload Picture'>";}
                            else{
                                echo "<img src='$pp' style='margin:0px 18px 0px -127px;border:solid black 1px;display:block;' class='img-circle' width='400px' height='200px'                                     alt='$pp'>";}
                            ?>
                </div>
             </div>
            </div>
        </div>  
                <div class="card teal-text text-darken-3 z-depth-1" style="margin: 136px 674px; width: 500px;">
                    <div class="card-content">
                        <span class="card-title"><h5><b><center>About</center></b></h5></span>
                    </div>
                    </div>
                    <hr>
                    <div class="card z-depth-1 teal-text text-darken-3" style="margin: -132px 674px; width: 500px;">
                     <div class="card-content">
...
if(!$con) {
    ...
    $sql="select * from news where ncat='$nc' and n_username='$u'";
    $retval=mysqli_query($con,$sql);
    $count=mysqli_num_rows($retval);
    $c=$count;
    $k=0;
