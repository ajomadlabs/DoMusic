    ...
    <nav>
      <div class="nav-wrapper teal darken-2 z-depth-1">
        ...
        <ul class="right hide-on-med-and-down" >
          ...
          <li><a href="login1.php" class="btn waves-effect waves-light white-text" style="margin-top: 12px;"><i class="fa fa-2x fa-power-off" style="margin: -12px;"></i></a></li>
        </ul>
      </div>
    </nav>
  </div>
        ...
        <ul id="nav-mobile" class="side-nav fixed white darken-2 z-depth-1" style="margin-top: 64px;">
           ...
           <div id="popup-content" class="card teal darken-2 z-depth-1">
...
?>
            ...
            echo "<div class='card teal darken-2 z-depth-1' style='width: 652px; margin-top: 31px; margin-left: -56px;'>";
