...
if($_SERVER["REQUEST_METHOD"]== "POST"){
    $un= $_POST["sear"];
    $n=$un[0];
    $sql="select * from song where sname like '$un%' and scat='hindi'";
...
<body>
  ...
  <div class="navbar-fixed">
    <nav>
      <div class="nav-wrapper teal darken-2 z-depth-5">
        ...
        <ul class="right hide-on-med-and-down">
           <li><a href="hgal.html">Image Box</a></li>
    ...
    <!--search bar-->
    <nav id="sea" style="width: 614px; margin-left: 633px;">
...
if(!$con) {
    ...
    $sql="select * from topsong where scat='hindi'";
    $retval=mysqli_query($con,$sql);
    $count=mysqli_num_rows($retval);
    $c=$count;
    $i=0;
...
?>
    <div class="row" style="margin-left:274px;">
         <h3 style="margin-left: 95px; margin-top: 33px;"><b class="teal-text text-darken-4" style="margin-left:-100px;">Top Five </b></h3>
        <div class="col s2" style="width: 273px; margin-left: -11px;margin-top:49px;">
          <div class="card teal darken-4 z-depth-5">
              <div>
                  <?php
                echo "<img src='$sim[0]' width='250px' height='162px'>
                  <h5 class='amber-text text-accent-4'>$sna[0]</h5>
                  <audio src='$sar[0]' controls preload loop class='black' style='width: 248px;'></audio>
                  </img>";
                    ?>
              </div>
            </div>
        ...
        <div class="col s2" style=" width: 273px;margin-top:49px;">
          <div class="card teal darken-4 z-depth-5">
              <div>
                  <?php
                echo "<img src='$sim[1]' width='250px' height='162px'>
                  <h5 class='amber-text text-accent-4'>$sna[1]</h5>
                  <audio src='$sar[1]' controls preload loop class='black' style='width: 248px;'></audio>
                  </img>";
                    ?>
              </div>
            </div>
          ...
          <div class="card teal darken-4 z-depth-5">
              <div>
                ...
                echo "<img src='$sim[2]' width='250px' height='157px'>
                  <h5 class='amber-text text-accent-4'>$sna[2]</h5>
                  <audio src='$sar[2]' controls preload loop class='black' style='width: 248px;'></audio>
                  </img>";
                    ?>
              </div>
            </div>
          ...
          <div class="card teal darken-4 z-depth-5">
              <div>
                ...
                echo "<img src='$sim[3]' width='250px' height='157px'>
                  <h5 class='amber-text text-accent-4'>$sna[3]</h5>
                  <audio src='$sar[3]' controls preload loop class='black' style='width: 248px;'></audio>
                  </img>";
                    ?>
              </div>
            </div>
        ...
        <div class="col s2" style=" width: 273px;margin-top:49px;">
          <div class="card teal darken-4 z-depth-5">
              <div>
                  <?php
                echo "<img src='$sim[1]' width='250px' style=height:162px>
                  <h5 class='amber-text text-accent-4'>$sna[1]</h5>
                  <audio src='$sar[1]' controls preload loop class='black' style='width: 248px;'></audio>
                  </img>";
                    ?>
...
if(!$con) {
    ...
    $sql="select * from topvideo where scat='hindi'";
    $retval=mysqli_query($con,$sql);
    $count=mysqli_num_rows($retval);
    $c=$count;
    $i=0;
...
?>
<div id="video" class="row" style="margin-top: 204px;padding-top:100px;margin-left:297px;">
         <h3 style="margin-left: 95px; margin-top: 33px;"><b class="teal-text text-darken-4" style="margin-left:-103px;">Top Viewed Vedios </b></h3>
 <?php
...
<div class="row" style="margin-top: 204px;margin-left:297px">
    <?php
echo "<video width='440' height='300' controls preload poster='$sim[3]' class='z-depth-5'>
  ...
  <source src='$sar[4]' type='video/mp4'>
    ...
    echo "<video width='440' height='300' controls preload poster='$sim[5]' class='z-depth-5'>
  <source src='$sar[5]' type='video/mp4'>
</video> ";
?>
</div>
