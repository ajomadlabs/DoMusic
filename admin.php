...
<script>$(document).ready(function(c) {
  ...
  <body>
      <div id="wrapper">
        ...
        <!-- /. NAV TOP  -->
        <nav class="navbar-default navbar-side" style="opacity: 0.9;">
        ...
        <!-- /. NAV SIDE  -->
          <!--notification-->
          <div class="col-md-4 z-depth-4" style="left: 819px; opacity: 0.9; background-color: #009688;">
                        <div class="card-panel hoverable" style="background-color: #00c899;">
                            ...
                            <div class="panel-body">
                                <div class="list-group">
                                    <a href="admin_userslist.php" class="list-group-item">
                                        <i class="fa fa-envelope fa-2x"></i>   User Count
                                    <span class="pull-right text-muted small"><?php echo $num_rows; ?></span>
                                    </a>
                                </div>
                                <!-- /.list-group -->
                                <a href="#" class="btn btn-info white" style="color: #00695c;">New Release</a>
                            </div>
