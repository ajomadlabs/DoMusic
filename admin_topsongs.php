...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sd=$_POST["sdetails"];
    $sim=$_POST["simage"];
    $sql="insert into topsong                                                values('$sn','$sc','$sf','$sd','$sim')";
      ...
      <div class="col-md-6 col-sm-6 col-xs-12" style="margin-left: 315px;">
               <div class="panel panel-danger">
                        <div class="panel-heading">
                          <button type="button" class=" btn-l btn-2 " style="margin-left: 20px;"> <a href="admin_topsongs.php">Add</a></button>
                   <button type="button" class=" btn-l btn-2 "><a href="admin_tsd.php">Remove</a></button>
                        </div>
                        <div class="panel-body">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="scat" id="scat">
                                        </div>
                                <div class="form-group">
                                            <label>Song File</label>
                                            <input class="form-control" type="text" name="sfile" id="sfile">
                                        </div>
                                <div class="form-group">
                                            <label>Song Details</label>
                                            <input class="form-control" type="text" name="sdetails" id="sdetails">
                                        </div>
                                <div class="form-group">
                                            <label>Song Image</label>
                                            <input class="form-control" type="text" name="simage" id="simage">
                                        </div>
                               
                                 
                                        <input type="submit" class="btn teal" value="Submit">
            <div>
            <?php
            if(empty($f))
            {
