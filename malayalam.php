...
if($_SERVER["REQUEST_METHOD"]== "POST"){
    $un= $_POST["sear"];
    $n=$un[0];
    $sql="select * from song where sname like '$un%' and scat='malayalam'";
...
<body>
  ...
  <div class="navbar-fixed">
    <nav>
      <div class="nav-wrapper teal darken-2 z-depth-5">
        ...
        <ul class="right hide-on-med-and-down">
           <li><a href="mgal.html">Image Box</a></li>
    ...
    <!--search bar-->
    <nav id="sea" style="width: 614px; margin-left: 649px;">
...
if(!$con) {
    ...
    $sql="select * from topsong where scat='malayalam'";
    $retval=mysqli_query($con,$sql);
    $count=mysqli_num_rows($retval);
    $c=$count;
    $i=0;
    ...
    <div class="row" style="margin-left:267px;">
        ...
        <div class="col s2" style=" width: 273px;margin-top:49px;">
          <div class="card teal darken-4 z-depth-5">
              <div>
                  <?php
                echo "<img src='$sim[1]' width='250px' height='160px'>
                  <h5 class='amber-text text-accent-4'>$sna[1]</h5>
                  <audio src='$sar[1]' controls preload loop class='black' style='width: 248px;'></audio>
                  </img>";
                        ?>
...
if(!$con) {
    ...
    $sql="select * from topvideo where scat='malayalam'";
    $retval=mysqli_query($con,$sql);
    $count=mysqli_num_rows($retval);
    $c=$count;
    $i=0;
...
?>
<div id="video" class="row" style="margin-top: 204px;padding-top:100px;margin-left:281px;">
         <h3 style="margin-left: 95px; margin-top: 33px;"><b class="teal-text text-darken-4" style="margin-left:-101px;">Top Videos </b></h3>
 <?php
...
<div class="row" style="margin-top: 204px;margin-left:281px;">
    <?php
