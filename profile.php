...
?>
    ...
    <nav>
      <div class="nav-wrapper teal darken-2 z-depth-5">
        ...
        <div>
        <ul id="nav-mobile" class="side-nav fixed white darken-2 z-depth-5" style="margin-top: 64px;">
...
if(!$con) {
    ...
    $sql="select * from news where ncat='$nc'";
    $retval=mysqli_query($con,$sql);
    $count=mysqli_num_rows($retval);
    $c=$count;
    $k=0;
...
?>
    <div class="row" style="margin-left:256px;">
        <div class="col s12 m6" style="margin-left: 284px;margin-top:0px;height: 79px;">
          <div class="card white darken-2 z-depth-1">
            <div class="card-content teal-text text-darken-3">
              <span class="card-title"><i class="fa fa-2x fa-newspaper-o" style="margin:15px;"></i>News Feeds</span>
              </div>
            </div>
        </div>
            </div>
       <div class="row">
        <div class="col s6" style="margin-left: 539px;margin-top:44px;width:834px;">
          <div class="card teal darken-2 z-depth-1">
            <div class="card-content white-text">
                <div class="input-field">
              <form method="post" action="">
                  <textarea type="text" name="content" id="content" class=" white darken-3 amber-text text-accent-4 validate materialize-textarea" style="width: 773px; height: 10px;" placeholder="Sing a new song"></textarea>
                  <label for="add" class="center-align"></label>
                  <input type="submit" name="postn" id="postn" value="Post" class="btn waves-effect waves-light white-text" style="margin: 6px 667px;">
                </form>
                    <!--tabox-->
            ...
            echo "<div class='card teal darken-2 z-depth-5' style='width: 652px; margin-top: 31px; margin-left: -56px;'>";
      ...
      echo "</div>";
             ...
             while($k!=0){
                  $k=$k-1;
            echo "<div class='row'>";
            echo "<div class='col s12 m6' style='margin-left: 595px;'>";
            echo "<div class='card teal darken-2 z-depth-1' style='width: 806px; margin-top: 31px; margin-left: -56px;'>";
            echo "<div class='card-content white-text'>";
            echo "<span style='margin: 57px;'><a href='userpage.php ? ar=$nu[$k]'>$nu[$k]</a>  Posted  @  $nt[$k]</span>";
           if($np[$k]=="nil"){
            echo "<span><img src='img/lu.jpg' width='50px' height='50px' style='margin: -32px 0px 4px; border-radius: 55px;'></img></span>";}
                 else{
