...
?>
<?php
    $ERR4="";$ERR5="";$ERR6="";$ERR7="";$pn="";$pad="";$pp=8086699507;$pc="";$pdp="";$pnc="";
$con=mysqli_connect("localhost","root","","domusic");
if(!$con) {
    die("Connection Failed:" .mysqli_connect_error());
}
...
if($_SERVER["REQUEST_METHOD"]=="POST" && !empty($_POST["save"])){
    ...
    $np=$_POST["lnpic"]; 
    $nu=$_POST["lnlnk"];
    $sql="insert into gennews values('$id','$nt','$ncn','$np','$nu')";
...
<script>$(document).ready(function(c) {
  ...
  <body>
      <div id="wrapper">
        ...
        <!-- /. NAV TOP  -->
                <ul class="side-nav fixed z-depth-5" id="main-menu" style="top: 64px; width: 230px; padding-left: 0px;position: fixed;">
            ...
            <div class="panel-body">
				  <form  action="" method="post">
                            <div class="form-group">
                               ...
                               <input class="form-control" type="text" name="lnid" id="lnid">
                            </div>
                            <div class="form-group">
                               <label>Enter News Title</label>
                               <input class="form-control" type="text" name="lntitle" id="lntitle">
                            </div>
                            <div >
								<label>Image</label>
                               <input class="form-control" type="text" name="lnpic" id="lnpic">
				            </div>
                            <div class="form-group">
                                <label> News Content</label>
                                <textarea class="form-control" rows="3" name="lncon" id="lncon"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Read More</label>
                                <input class="form-control" type="text" name="lnlnk" id="lnlnk">
                           </div>
								<center><input type="submit" id="save" name="save" class="btn teal" value="Submit"></center> 
<div>
<?php
    if(empty($f))
    {
