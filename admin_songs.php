...
if($_SERVER["REQUEST_METHOD"]=="POST"){
  $si=$_POST["sid"];
    ...
    $sd=$_POST["sdetails"];
    $sim=$_POST["simage"];
    $sql="insert into song                                                 values('$si','$sn','$sc','$sf','$sd','$sim')";
      ...
      <div class="col-md-6 col-sm-6 col-xs-12" style="margin-left: 315px;">
               <div class="panel panel-danger">
                        <div class="panel-heading">
                          <button type="button" class=" btn-l btn-2 " style="margin-left: 20px;"> <a href="admin_songs.php">Add</a></button>
                   <button type="button" class=" btn-l btn-2 "><a href="admin_sd.php">Remove</a></button>
                        </div>
