                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>6</td>
                                            <td>TopSong Table</td>
                                            <td>List out the top songs in each category details which can be downloaded</td>
                                        </tr>
                                        <tr>
                                            <td>7</td>
                                            <td>TopTen Table</td>
                                            <td>Top ten songs of all the category will be listed in the home page </td>
                                        </tr>
                                        <tr>
                                            <td>8</td>
                                            <td>TopArtist Table</td>
                                            <td>List out the top artists of the week in each category</td>
                                        </tr>
                                        <tr>
                                            <td>9</td>
                                            <td>TopVideo Table</td>
                                            <td>List out the top videos in each category</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
