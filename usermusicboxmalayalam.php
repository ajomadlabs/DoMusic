...
if(!$con) {
    ...
    $sql="select * from song where scat='malayalam'";
        ...
        <div class="input-field z-depth-1">
          <input class="teal-text text-darken-4" id="search" type="search" required name="sear" style="margin-top:-94px">
            ...
            <div class="navbar-fixed" style="margin:0px;">
                ...
                <i class="fa fa-2x fa-music  teal-text text-darken-4" style="margin:0px 250px"></i><span class=" teal-text text-darken-4" style="margin:0px -235px;font-size:30px">Malayalam</span>
                </nav>
            </div>
            <table style="margin: 0px 249px;" class="bordered highlight">
        <thead >
          <tr>
              <th data-field="name" style="padding-left:-54px">Name</th>
